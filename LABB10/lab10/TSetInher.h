...
public:
	...
	TSetInher<T> unite(TSetInher<T> &t);

	TSetInher<T> sub(TSetInher<T> &t);

	TSetInher<T> intersect(TSetInher<T> &t);
...
template<class T>
TSetInher<T> TSetInher<T>::unite(TSetInher<T> &t) {
	TSetInher res;
...
template<class T>
TSetInher<T> TSetInher<T>::sub(TSetInher<T> &t) {
	TSetInher res;
...
template<class T>
TSetInher<T> TSetInher<T>::intersect(TSetInher<T> &t) {
	TSetInher res;
